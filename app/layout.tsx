...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Nidhi ERP',
    'Nidhi Core Banking',
    'Veritasco Restaurant POS',
    'Top Restaurant POS Software in India',
    'Restaurant POS Billing Software',
    'Online Ordering System for Restaurants',
    'Restaurant KDS Software',
    'School Management System with Biometric',
    'Biometric Attendance School ERP',
    'BazarChowk App',
    'BazarChowk Local Delivery',
    'Bazar Chowk Groceries',
    'Nidhi Company Software in India',
    'Best Nidhi Software Provider',
    'Nidhi Banking App',
    'IFSC NEFT IMPS Nidhi Software',
    'Credit Society Software',
    'Microfinance Software India',
    'VeritasCo Solutions',
    'School Fees Management App',
    'POS Machine for Restaurant',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'SoftwareApplication',
      '@id': `${siteUrl}/#product-pos`,
      name: 'VeritasCo Restaurant POS',
      applicationCategory: 'BusinessApplication',
      operatingSystem: 'Web, Android, iOS',
      url: `${siteUrl}/pos`,
      description: 'Advanced QR-based ordering, KDS, and billing management software for modern restaurants and cafes.',
      offers: {
        '@type': 'Offer',
        price: '0',
        priceCurrency: 'INR',
